        ...
        (
            ...
            async ( recognitionState ) =>
            {
                ...
                if ( blinkIdImageCaptureResults.state !== BlinkIDImageCaptureSDK.RecognizerResultState.Empty )
                {
                    ...
                    else if ( !blinkIdImageCaptureResults.backCameraFrame.frame )
                    {
                    ...
                    else
                    {
                        ...
                        getWebApiResults(
                            blinkIdImageCaptureResults.frontCameraFrame.frame,
                            blinkIdImageCaptureResults.backCameraFrame.frame
                        );
                    }
                }
