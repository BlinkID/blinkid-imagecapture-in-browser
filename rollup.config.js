...
const config = {
    ...
    cjs: {
        input: 'src/index.ts',
        output: {
            file: 'lib/blinkid-imagecapture-sdk.js',
            format: 'cjs',
            indent: false,
            banner: bannerMsg
        },
        plugins: [
            ...
            babel({ babelHelpers: 'bundled' }),
            replaceWorker('resources/BlinkIDImageCaptureSDK.worker.min.js')
        ]
    },
    es: {
        input: 'src/index.ts',
        output: {
            file: 'es/blinkid-imagecapture-sdk.js',
            format: 'es',
            indent: false,
            sourcemap: true,
            banner: bannerMsg
    ...
    esModule: {
        input: 'src/index.ts',
        output: {
            file: 'es/blinkid-imagecapture-sdk.mjs',
            format: 'es',
            indent: false,
            banner: bannerMsg
        },
