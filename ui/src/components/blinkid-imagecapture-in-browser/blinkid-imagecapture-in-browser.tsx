...
@Component({
  tag: 'blinkid-imagecapture-in-browser',
  styleUrl: 'blinkid-imagecapture-in-browser.scss',
  shadow: true,
})
export class BlinkidImageCaptureInBrowser implements MicroblinkUI {
   ...
   *
   * `<blinkid-imagecapture-in-browser recognizers="BlinkIdImageCaptureRecognizer"></blinkid-imagecapture-in-browser>`
   */
   ...
   * blinkId.recognizers = ['BlinkIdImageCaptureRecognizer'];
   * ```
   */
   ...
   *
   * The only available option is 'captureBothDocumentSides', which enables scanning of both document sides.
   *
   * Example:
   *
