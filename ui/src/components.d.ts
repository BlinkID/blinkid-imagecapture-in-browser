...
declare global {
    interface HTMLBlinkidImagecaptureInBrowserElement extends Components.BlinkidImagecaptureInBrowser, HTMLStencilElement {
    }
    var HTMLBlinkidImagecaptureInBrowserElement: {
        prototype: HTMLBlinkidImagecaptureInBrowserElement;
        new (): HTMLBlinkidImagecaptureInBrowserElement;
    };
