...
<script type="module" src="https://unpkg.com/@microblink/blinkid-imagecapture-in-browser-sdk@X.Y.Z/ui/dist/blinkid-imagecapture-in-browser/blinkid-imagecapture-in-browser.esm.js"></script>
<script nomodule src="https://unpkg.com/@microblink/blinkid-imagecapture-in-browser-sdk@X.Y.Z/ui/dist/blinkid-imagecapture-in-browser.js"></script>
...
For example, all versions of BlinkID ImageCapture In-browser SDK are available on Unpkg CDN:

* Visit `https://unpkg.com/browse/@microblink/blinkid-imagecapture-in-browser-sdk@X.Y.Z/resources/` (change "X.Y.Z" to the version number you wish to use).
...
3. Here's one possible way to use `<blinkid-imagecapture-in-browser>` custom web component inside React:
